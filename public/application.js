...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://prostock-systems.herokuapp.com/',
...
var onCreatePart = function onCreatePart(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createPart(data).then(ui.getCreatePartSuccess).then(function () {
    return onLoadParts(event);
  }).catch(ui.getCreatePartFailure);
};

// This function reloads the part-content div whenever an action is expected to take place.
var onLoadParts = function onLoadParts(event) {
  api.getParts().then(ui.loadPartSuccess);
};

// onGetParts function that links to getParts API Call
var onGetParts = function onGetParts(event) {
  api.getParts().then(ui.getPartsSuccess);
};

// onUpdatePart function that links to updateParts API Call
var onUpdatePart = function onUpdatePart(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // const partId = $(event.target).closest('td').attr('data-id')
  api.updateParts(data).then(ui.getUpdatePartSuccess).then(function () {
    return onLoadParts();
...
var onDeletePart = function onDeletePart(event) {
  ...
  // const partId = $(event.target).closest('td').attr('data-id')
  console.log(data);
  api.destroyParts(data).then(ui.getDeletePartSuccess).then(function () {
    return onLoadParts();
...
var partEvents = __webpack_require__(6);
...
var createPart = function createPart(data) {
  return $.ajax({
...
var getParts = function getParts(data) {
  return $.ajax({
    url: config.apiUrl + '/parts',
    method: 'GET',
    headers: {
...
var updateParts = function updateParts(data) {
  console.log(data);
  return $.ajax({
...
var destroyParts = function destroyParts(data) {
  return $.ajax({
...
var showPartTemplate = __webpack_require__(18);
var showPartTableTemplate = __webpack_require__(35);

var getPartsSuccess = function getPartsSuccess(data) {
  var showPartHTML = showPartTableTemplate({ parts: data.parts });
...
var loadPartSuccess = function loadPartSuccess(data) {
  var showPartHTML = showPartTableTemplate({ parts: data.parts });
  $('.part-content').html(showPartHTML);
  if (data.parts.length === 0) {
    $('.part-content').html('<h3> You do not have any parts in your inventory</h3>');
...
var getPartsFailure = function getPartsFailure(data) {
...
var getCreatePartSuccess = function getCreatePartSuccess() {
  $('input[type=text]').val('');
...
var getCreatePartFailure = function getCreatePartFailure() {
...
var getUpdatePartSuccess = function getUpdatePartSuccess() {
  $('input[type=text]').val('');
  $('input[type=number]').val('');
...
var getUpdatePartFailure = function getUpdatePartFailure() {
...
var getDeletePartSuccess = function getDeletePartSuccess() {
...
var getDeletePartFailure = function getDeletePartFailure() {
...
module.exports = {
  getPartsSuccess: getPartsSuccess,
  getPartsFailure: getPartsFailure,
  loadPartSuccess: loadPartSuccess,
  getCreatePartSuccess: getCreatePartSuccess,
  getCreatePartFailure: getCreatePartFailure,
  getUpdatePartSuccess: getUpdatePartSuccess,
  getUpdatePartFailure: getUpdatePartFailure,
  getDeletePartSuccess: getDeletePartSuccess,
  getDeletePartFailure: getDeletePartFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "   <div class=\"part-data\">\n    <p data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"></p>\n    <p> Sku:\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.sku : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </p>\n    <p> Name:\n"
    ...
    + "    </p>\n    <p> Quantity:\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          <form class=\"update-part\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <p>Name: <input required type=\"text\" name=\"part[name]\" placeholder=\"Part Name\"> </p>\n            <p>Description: <input required type=\"text\" name=\"part[description]\" placeholder=\"Description\"> </p>\n            <p>SKU: <input required type=\"text\" name=\"part[sku]\" placeholder=\"SKU\"> </p>\n            <p>Quantity: <input required type=\"number\" name=\"part[quantity]\" min=\"1\" max=\"999999\" placeholder=\"1,2,3\"> </p>\n            <input type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" name=\"submit\" value=\"Update Part\">\n          </form>\n        </div>\n        <div class=\"footer-status\">\n        </div>\n        </div>\n      </div>\n    </div>\n    <!--End of Update Modal   -->\n    <button type=\"button\" class=\"btn classic destroy-id\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
  ...
  return "      "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.sku : stack1), depth0))
    + "\n";
  ...
  return "\n\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.parts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <tr class=\"part-data\">\n    <!--Printing Out the ID of every part  -->\n    <td data-id=\""
    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <!--Printing out the Name of every part  -->\n    <td>\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.name : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.program(6, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <!--Printing out the SKU of every part  -->\n    <td>\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.sku : stack1),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams),"inverse":container.program(10, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <!--Printing out the Description of every part  -->\n    <td>\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(12, data, 0, blockParams),"inverse":container.program(14, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n    <!--Printing out the Quatity of every part  -->\n    <td>\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1),{"name":"if","hash":{},"fn":container.program(16, data, 0, blockParams),"inverse":container.program(18, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </td>\n  </tr>\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
  ...
  return "<table class=\"table table-bordered\" >\n  <tr class=\"table-headings\">\n    <th class=\"headings text-center\">ID</th>\n    <th class=\"headings text-center\">NAME</th>\n    <th class=\"headings text-center\">SKU</th>\n    <th class=\"headings text-center\">DESCRIPTION</th>\n    <th class=\"headings text-center\">QUANTITY</th>\n  </tr>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.parts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</table>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = __webpack_require__.p + "cddf33f3397ba04e99cd70e7232179a3.jpg";
